...
func init() {
	...
	utilruntime.Must(myplatformv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	if err = (&controllers.InhouseAppReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "InhouseApp")
		os.Exit(1)
	}
